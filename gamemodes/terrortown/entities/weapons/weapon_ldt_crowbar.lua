...
if SERVER then
   ...
   resource.AddFile("sound/crowbar/grunt1.mp3")
   resource.AddFile("sound/crowbar/grunt2.mp3")
   resource.AddFile("sound/crowbar/grunt3.mp3")
   resource.AddFile("sound/crowbar/grunt4.mp3")
   resource.AddFile("sound/crowbar/grunt5.mp3")
   resource.AddFile("sound/crowbar/swoosh.mp3")
end
...
--Throws crowbar similar to knife
function SWEP:Reload()
   ...
   if not self.Owner:HasWeapon("weapon_ldt_crowbar") then return false end
   if not IsFirstTimePredicted() then return false end
   if not SERVER then return false end
   if self.Tossed then return false end
   ...
   if SERVER then
      ...
      local knife = ents.Create("ldt_crowbar_proj")
      if not IsValid(knife) then return false end
      knife:SetPos(src)
      knife:SetAngles(knife_ang)
      knife.Owner = self.Owner

      self.Owner:EmitSound("/crowbar/grunt"..math.random(1,5)..".mp3", 75, math.random(90,130), 1, CHAN_AUTO)
