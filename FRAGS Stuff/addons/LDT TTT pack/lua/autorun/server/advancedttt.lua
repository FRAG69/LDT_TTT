...
local advttt_sprint_enabled = CreateConVar("ttt_advttt_sprint_enabled", "0", FCVAR_ARCHIVE)
...
local advttt_dmg_enabled= CreateConVar("ttt_advttt_dmg_enabled", "1", FCVAR_ARCHIVE)
...
local advttt_eff_legslowdown = CreateConVar("ttt_advttt_eff_legslowdown", "4", FCVAR_ARCHIVE)

-- Should player speed be modified based on the weapon they're carrying
local advttt_eff_weaponweight = CreateConVar("ttt_advttt_eff_weaponweight_enabled", "0", FCVAR_ARCHIVE)
