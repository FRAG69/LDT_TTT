	...
	if SERVER then
		...
		if IsValid(ply) then
			...
			if IsValid(HaxBox) then
				...
				timer.Simple( 4, function() HaxBox.MakeHax( HaxBox,0,15 ) end )
				timer.Simple( 4.5, function() HaxBox.MakeHax( HaxBox,0,15 ) end )
				timer.Simple( 5, function() HaxBox.MakeHax( HaxBox,0,15 ) end )
				timer.Simple( 5.5, function() HaxBox.MakeHax( HaxBox,0,15 ) end )
				timer.Simple( 6, function() HaxBox.MakeHax( HaxBox,0,15 ) end )
			end
			self:Remove()
		end
	end
