...
function PANEL:Init( )
	...
	if LocalPlayer( ):CanOverride( ) then
		...
		self.adminOverride:SetColor( MAPVOTE.TextColor )
	...
	self.numRatingsLabel:SetFont( "MapName" )
	
	self.label = vgui.Create( "DLabel", self )
	self.label:SetColor( MAPVOTE.TextColor )
	self.label:DockMargin( 0, 5, 0, 0 )
	self.label:Dock( TOP )
	self.label:SetFont( "MapName" )
	...
	self.scoreLabel:SetColor( MAPVOTE.TextColor )
