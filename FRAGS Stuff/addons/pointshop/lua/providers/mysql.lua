...
local mysql_hostname = 'floodps.db.11139195.hostedresource.com' -- Your MySQL server address.
local mysql_username = 'floodps' -- Your MySQL username.
local mysql_password = 'Itsameamario1!' -- Your MySQL password.
local mysql_database = 'floodps' -- Your MySQL database.
