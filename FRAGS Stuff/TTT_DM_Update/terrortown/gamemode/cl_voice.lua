...
function RADIO:GetTargetType()
   ...
   if ent:IsPlayer() then
      ...
      elseif (ent:GetNWBool("Impersonate",false)) then
		 local impent = ent:GetNWEntity("ImpTarget",IsEntity())
		 if IsValid(impent) then return impent, false end
	     return ent:GetNWString("ImpName",""), false
