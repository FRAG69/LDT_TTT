...
surface.CreateFont("HealthAmmo",   {font = "Trebuchet24",
                                    size = 24,
                                    weight = 750})
surface.CreateFont("header",       {font = "Monaco",
                                    size = 15,
                                    weight = 1000000})
...
function GM:HUDPaint()
   ...
   draw.SimpleTextOutlined( "[LDT] Trouble in Terrorist Town | TTT | LDT-clan.com", "header", (ScrW()/2), ScrH()*0.9, Color(29,212,215), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1.5, Color(0,0,0) )
   end
