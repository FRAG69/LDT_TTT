...
Please Verify your account by clicking the following link : http://" . $_SERVER['HTTP_HOST'] . "/frag_tracker/verify.php?email=" . $verifyEmail . "&hash=" . $myHash . "
...
if ($results == 1){
$search = mysql_query("UPDATE `fragstats`.`admin_users` SET `last_login` = now(), `active` = '1' WHERE `admin_users`.`email` = '$adminEmail'");
