...
$message = "Automated message " . $_SERVER['HTTP_HOST'] . "/fragstats 
...
[TTT STAT TACKER] - " . $_SERVER['HTTP_HOST'] . "/fragstats";
...
$check = mysql_query("UPDATE `fragstats`.`admin_users` SET `pass` = MD5('$newpassword') WHERE `admin_users`.`ID` ='$userID'");
