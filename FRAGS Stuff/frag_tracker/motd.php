...
//an example of this would be: http://thehiddennation.com/fragstats/motd.php?steamid=%s
//so for a loadingurl in the server.cfg your example would be:
//sv_loadingurl "http://thehiddennation.com/fragstats/motd.php?steamid=%s"
