if (SERVER) then
	...
	resource.AddFile( "materials/VGUI/ttt/icon_ldttttflash.vtf" )
	resource.AddFile( "materials/VGUI/ttt/icon_ldttttflash.vmt" )
...
if (CLIENT) then
    ...
    SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = "Blinds your enemies or friends."
   };

    SWEP.Icon = "VGUI/ttt/icon_ldttttflash"
end
---TTT STUFF--- BY KAZAKI
