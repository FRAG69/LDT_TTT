...
if SERVER then
   ...
   resource.AddFile( "models/turret.mdl")
   resource.AddFile( "models/turret.dx80.vtx")
   resource.AddFile( "models/turret.dx90.vtx")
   resource.AddFile( "models/turret.sw.vtx")
   resource.AddFile( "models/turret.vvd")
end
...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
		type = "item_weapon",
		desc = "Automatic Turret. Place on flat ground.\nOnly attacks innocents!\n\nNot very stable."
   };
...
function SWEP:DropTurret()
	if SERVER then
		...
		turret:SetMaterial( "models/turret.mdl")
		turret:SetColor(Color( 255, 0, 0, 255 ))
		turret:Spawn()
		...
		local vectur = Angle(0, ply:EyeAngles().yaw, 0)
