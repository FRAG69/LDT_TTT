...
--Who can select to spawn with a primary?
WEAPONSELECTION_PRIMARIES_GROUPS = { "vip", "donator", "LDT_donator", "LDT_gold", "admin", "superadmin", "owner" }
...
WEAPONSELECTION_SECONDARIES_GROUPS = { "vip", "donator", "LDT_donator", "LDT_silver", "LDT_gold", "admin", "superadmin", "owner" }

--Grenades
WEAPONSELECTION_GRENADES =
	{ weapon_ttt_smokegrenade = {} }
	   
--Who can select to spawn with a grenade?
WEAPONSELECTION_GRENADES_GROUPS = { "vip", "donator", "LDT_donator", "LDT_gold", "admin", "superadmin", "owner" }